...
it's the next player's turn. (Hint: Always save the previous dice roll in a separatevariable)
2. Add an input field to the HTMl where players can set the winning score, so that
they can change predefined score of 100. (Hint: you can read that value with the 
